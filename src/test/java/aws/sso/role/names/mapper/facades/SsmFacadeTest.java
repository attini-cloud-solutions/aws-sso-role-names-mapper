...
public class SsmFacadeTest {
    ...
    public void deleteParameters_SsmError_ShouldReturnFalse() {
        ...
        assertFalse(ssmFacade.deleteParameters(SsmDeleteParametersRequest.create(Region.EU_WEST_3, emptySet())));
    }
    ...
    @Test
    public void deleteParameters_EmptyRequest_ShouldReturnFalse() {
        when(ssmClientFactoryMock.createSsmClient(any(Region.class))).thenReturn(ssmClientMock);
        when(ssmClientMock.deleteParameters(DeleteParametersRequest.builder().names(emptySet()).build()))
                .thenThrow(SsmException.class);
        assertFalse(ssmFacade.deleteParameters(SsmDeleteParametersRequest.create(EU_WEST_3, emptySet())));
    }
    ...
    public void deleteParameters_ValidRequest_ShouldReturnTrue() {
        ...
        assertTrue(ssmFacade.deleteParameters(SsmDeleteParametersRequest.create(EU_WEST_3, params)));
    }
